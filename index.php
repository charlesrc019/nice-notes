...
<html>
  ...
  <head>
    <title>Nice Notes | [ORG_NAME]</title>
  ...
  <body>
    <div class="container">
      ...
      <div class="jumbotron mt-4 px-4 pb-1 pt-3">
        <h1>Nice Notes</h1>
        <p class="lead">Marsh Creek YSA Branch</p>
      </div>
      <?php 
        if ($_GET['sent'] == "true") {
...
?>
          ...
          <div class="form-group">
            ...
            <textarea name="msg" class="form-control" id="message" rows="5"></textarea>
            <p><small>Message sent via SMS.</small></p>
          </div>
          <button type="submit" class="form-control btn btn-primary" id="submit" disabled>Send</button>
        </form>
      </div>
